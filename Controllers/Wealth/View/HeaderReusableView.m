...
- (void)createPageControl
{
    ...
    _pageControl.frame = CGRectMake((kScreenW/2 - 39*proportion/2.0), AD_SCROLLVIEW_HEIGHT - 25*proportionHeight, 39*proportion, pageControSize.height*proportionHeight);
